...
- 2024: Supervisor to Wilhelm Ahlqvist and Gabriel Diskay for master thesis [*Software Cost Estimation in Practice: A case-study on evaluating, validating, and implementing an estimation model for real-world use*](http://www.diva-portal.org)
